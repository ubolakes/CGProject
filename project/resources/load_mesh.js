...
// function to read an eventually associated MTL file
...
// function to load data from OBJ file
...
// function to read the content of an OBJ file
...
// uncomment to use LoadSubdivMesh
...
function LoadMesh(gl,mesh) {
   ...
   var texture = loadTexture(gl, path, map.get("map_Kd"));
   ...
   // outputting parameters for each mesh as an object
   return {
      positions: positions,
      normals: normals,
      texcoords: texcoords,
